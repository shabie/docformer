# -*- coding: utf-8 -*-
"""DocFormer Pre-training : 3. Modeling for DocFormer

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14k5rzz4jWHInyQrON-D5-6GWLjqfdkg_
"""
...
class DataModule(pl.LightningDataModule):
  ...
  def __init__(self, train_dataset,  batch_size = 2):
...
class DocFormer(pl.LightningModule):
  ...
  def training_step(self, batch, batch_idx):
    ...
    loss = F.cross_entropy(
                  ...
                  batch['labels'],
                  ignore_index = self.ignore_input_id
              )
...
def main():
    datamodule = DataModule(MyDataset(img_list, ocr_list))
    docformer = DocFormer(config)

    checkpoint_callback = ModelCheckpoint(
        dirpath="./docformer_train/models", monitor="train_ce_loss", mode="min", filename = 'docformer_best_ckpt'
    )

    pl.seed_everything(42, workers=True)
    trainer = pl.Trainer(
        default_root_dir = "./docformer_train/logs",
        devices = "auto",
        accelerator = "auto",
        max_epochs=2,
        logger=pl.loggers.TensorBoardLogger("./docformer_train/logs", name="idl_dataset", version=1),
